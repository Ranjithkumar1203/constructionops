...
export class EditWorkScheduleComponent implements OnInit {
  ...
  selctWeekOpen = false
  hourTableOpen = false
  selectWeekStart = this.data.weekStart;
  setStartHour: any
  ...
  constructor(private library: LibraryService, private router: Router, private apiservice: ApiServiceService, public dialogRef: MatDialogRef<EditWorkScheduleComponent>, @Inject(MAT_DIALOG_DATA) public data: any) { }
  ...
  ngOnInit(): void {
    ...
    //   this.checkedLists = [];
    //   const newString = this.data.dayStart.slice(0, -2);
    //   this.setStartHour = newString;
    //   this.allDayArray.length = this.data.numberOfDays;
    //   this.allDayArray = this.data.workingDays.split(',')
    //   this.selectDays.map((ele) => {
    //     if (this.allDayArray.includes(ele.value) == true) {
    //       ele.checked = true
    //       this.checkedLists.push(ele);
    //     }
    //   })
    //   this.luncktimeHandler();
    //   this.autonaming();
    //   // const interval = setInterval(() => {
    //   //   if (this.nameswitch == true) {
    ...
    //   let e = 0;
    //   let f = 0;
    //   a = this.data.lunchBreak.toString();
    //   if (a.length == 1) {
    //     this.lunuchtime1 = 0;
    //     this.lunuchtime2 = 0;
    //     this.lunuchtime3 = 0;
    //     this.lunuchtime4 = a;
    //   } else if (a.length == 2) {
    //     b = this.data.lunchBreak.toString().split('');
    //     c = b[0];
    //     d = b[1];
    //     this.lunuchtime1 = 0;
    //     this.lunuchtime2 = 0;
    ...
    // openCheckBox = (allDay: any) => {
    //   this.selctWeekOpen = false
    //   this.hourTableOpen = false
    //   this.checkedLists = [];
    //   this.allDayArray = [];
    //   this.allDayArray = allDay.split(',')
    //   this.selectDays.map((ele) => {
    //     if (this.allDayArray.includes(ele.value) == true) {
    //       ele.checked = true
    //       this.checkedLists.push(ele);
    ...
    //   this.checkedList = this.allDayArray;
    ...
    //       this.allDayArray.push(val.value)
    //       this.checkedDayInString = this.allDayArray.toString();
    //       this.autonaming();
    //     });
    //   }
    //   else {
    ...
    //           this.checkedLists.push(optionvalue);
    //           this.allDayArray.push(optionvalue.value)
    //           this.checkedDayInString = this.allDayArray.toString();
    //           this.stringdays = this.allDayArray.toString();
    //           this.autonaming();
    //         }
    //       });
    //     });
    ...
    //     numberOfDays: this.allDayArray.length,
    ...
    //     HoursWorked: this.workScheduleForm.controls.hoursworked.value,
    ...
    //   console.log(data)
    //   this.apiservice.updateWorkLibrary(data).subscribe((res) => {
    ...
    //         }
    //       });
    //       this.naming = this.allDayArray.length + ' Day Workweek, ' + value1 + ' - ' + value2 + ', ' + this.setStartHour + ' ' + this.selectMeridiem + ' to ' + a;
    //     } else {
    //       this.naming = this.allDayArray.length + ' Day Workweek, ' + this.checkedDayInString + ', ' + this.setStartHour + ' ' + this.selectMeridiem + ' to ' + a;
    //     }
    //   } else {
    //     let a = '';
    //     if (this.selectMeridiem == 'AM') {
    ...
    this.library.getworks().subscribe((val) => {
      ...
      val.forEach((itemworkk: any) => {
        itemworkk['name'] = itemworkk.workScheduleName,
          ...
          itemworkk['lunch'] = itemworkk.hoursWorking.split(',')[1],
          ...
          itemworkk['vlunch'] = itemworkk.hoursWorking.split(',')[1],
        ...
        if (itemworkk.hoursWorking.split(',')[0] == '1 Hour') {
          itemworkk.hournumber = 1;
        } else if (itemworkk.hoursWorking.split(',')[0] == '2 Hours') {
          itemworkk.hournumber = 2;
        } else if (itemworkk.hoursWorking.split(',')[0] == '3 Hours') {
          itemworkk.hournumber = 3;
        } else if (itemworkk.hoursWorking.split(',')[0] == '4 Hours') {
          itemworkk.hournumber = 4;
        } else if (itemworkk.hoursWorking.split(',')[0] == '5 Hours') {
          itemworkk.hournumber = 5;
        } else if (itemworkk.hoursWorking.split(',')[0] == '6 Hours') {
          itemworkk.hournumber = 6;
        } else if (itemworkk.hoursWorking.split(',')[0] == '7 Hours') {
          itemworkk.hournumber = 7;
        } else if (itemworkk.hoursWorking.split(',')[0] == '8 Hours') {
          itemworkk.hournumber = 8;
        } else if (itemworkk.hoursWorking.split(',')[0] == '9 Hours') {
          itemworkk.hournumber = 9;
        } else if (itemworkk.hoursWorking.split(',')[0] == '10 Hours') {
          itemworkk.hournumber = 10;
        } else if (itemworkk.hoursWorking.split(',')[0] == '11 Hours') {
          itemworkk.hournumber = 11;
        } else if (itemworkk.hoursWorking.split(',')[0] == '12 Hours') {
          itemworkk.hournumber = 12;
        } else if (itemworkk.hoursWorking.split(',')[0] == '13 Hours') {
          itemworkk.hournumber = 13;
        } else if (itemworkk.hoursWorking.split(',')[0] == '14 Hours') {
          itemworkk.hournumber = 14;
        } else if (itemworkk.hoursWorking.split(',')[0] == '15 Hours') {
          itemworkk.hournumber = 15;
        } else if (itemworkk.hoursWorking.split(',')[0] == '16 Hours') {
          itemworkk.hournumber = 16;
        } else if (itemworkk.hoursWorking.split(',')[0] == '17 Hours') {
          itemworkk.hournumber = 17;
        } else if (itemworkk.hoursWorking.split(',')[0] == '18 Hours') {
          itemworkk.hournumber = 18;
        } else if (itemworkk.hoursWorking.split(',')[0] == '19 Hours') {
          itemworkk.hournumber = 19;
        } else if (itemworkk.hoursWorking.split(',')[0] == '20 Hours') {
          itemworkk.hournumber = 20;
        } else if (itemworkk.hoursWorking.split(',')[0] == '21 Hours') {
          itemworkk.hournumber = 21;
        } else if (itemworkk.hoursWorking.split(',')[0] == '22 Hours') {
          itemworkk.hournumber = 22;
        } else if (itemworkk.hoursWorking.split(',')[0] == '23 Hours') {
          itemworkk.hournumber = 23;
        } else if (itemworkk.hoursWorking.split(',')[0] == '24 Hours') {
    ...
    this.options.forEach((val: any) => {
      if (val.id == optionid) {
        ...
        if (val.checked == false) {
          ...
          console.log('okture', this.checkedLists);
        } else {
          val.checked = false;
          for (var i = 0; i < this.options.length; i++) {
            if (this.checkedList[i] == option) {
          ...
          this.vcheckedvalues(id);
          console.log('okfalse', this.checkedLists);
        }
      }
    });
    ...
    this.workimports.forEach((val: any) => {
      if (val.id == id) {
        ...
        let updateCon = {
          ...
          "hoursWorking": vworkhours + ',' + val.vlunch,
        };
        this.library.update(updateCon).subscribe((val) => {
          console.log("updated");
          //this.workimports=val;
