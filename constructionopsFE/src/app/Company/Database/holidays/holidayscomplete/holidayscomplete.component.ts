...
@Component({
  selector: 'app-holidayscomplete',
  templateUrl: './holidayscomplete.component.html',
  styleUrls: ['./holidayscomplete.component.css']
})
export class HolidayscompleteComponent implements OnInit {
  @ViewChild(HolidaysaddComponent) child!: HolidaysaddComponent;
  @ViewChild(HolidayscreateComponent) child1!: HolidayscreateComponent;
  constructor(private library: HolidayLibraryService, private router: Router) { }
  ...
  ngOnInit(): void {
    ...
    this.library.getholidays().subscribe((val) => {
      val.forEach((itemworkk: any) => {
        ...
        if (itemworkk.ruleSetting == 'Standard') {
          itemworkk.standardrule = true;
          itemworkk.customerule = false;
          itemworkk.norule = false;
        } else if (itemworkk.ruleSetting == 'Custom') {
          itemworkk.customerule = true;
          itemworkk.standardrule = false;
          itemworkk.norule = false;
        } else if (itemworkk.ruleSetting == 'No') {
          ...
          if (a == 3) {
            ...
            this.holidays.forEach((val: any) => {
              ...
              if (val.holidayId == id) {
                ...
                document.getElementById('editrow6holiday' + id)?.classList.remove('hide');
                document.getElementById('editrow7holiday' + id)?.classList.add('hide');
                document.getElementById('editrow8holiday' + id)?.classList.remove('hide');
                document.getElementById('editrow9holiday' + id)?.classList.add('hide');
          ...
          if (b == 3) {
            ...
            this.holidays.forEach((val: any) => {
              ...
              if (val.holidayId == id) {
                ...
                document.getElementById('editrow6holiday' + id)?.classList.add('hide');
                document.getElementById('editrow7holiday' + id)?.classList.remove('hide');
                document.getElementById('editrow8holiday' + id)?.classList.add('hide');
                document.getElementById('editrow9holiday' + id)?.classList.remove('hide');
                document.getElementById('hourworkdayseletexttimetext' + val.holidayId)?.classList.remove('hide');
                document.getElementById('workdayseletexttime' + val.holidayId)?.classList.remove('hide');

                document.getElementById('hourbuttondaystime' + val.holidayId)?.classList.add('hide');
                document.getElementById('buttondaystime' + val.holidayId)?.classList.add('hide');
                document.getElementById('checkdaystime' + val.holidayId)?.classList.add('hide');
                document.getElementById('hourworkdayseletexttime' + val.holidayId)?.classList.add('hide');
                document.getElementById('workdayseletexttimetext' + val.holidayId)?.classList.add('hide');
              }
            });
          }
        }, 300);
  ...
  switchalterobservation(id: any, workhour: any) {
    if (this.observationactive == false) {
      ...
      this.holidays.forEach((val: any) => {
        this.numberobservationclose(id);
        if (val.holidayId != id) {
          this.alterobservationcheck(val.holidayId);
    ...
    this.holidays.forEach((val: any) => {
      if (val.holidayId == id) {
        ...
        if (val.ruleSetting == 'Standard') {
          ...
          document.getElementById('customeruletext')?.classList.add('opacitycolour');
          document.getElementById('noruletext')?.classList.add('opacitycolour');
        } else if (val.ruleSetting == 'Custom') {
  ...
  activeweek() {
    this.singleholiday.forEach((val: any) => {
      ...
      if (val.vruleSetting == 'Standard') {
        ...
        document.getElementById('customeruletext')?.classList.add('opacitycolour');
        document.getElementById('noruletext')?.classList.add('opacitycolour');
      } else if (val.vruleSetting == 'Custom') {
        val.customerule = true;
        val.standardrule = false;
        val.norule = false;
        this.standardrulerow = false;
  ...
  select(event: any, id: any) {
    ...
    if (event.target.checked) {
      ...
      let index1 = this.viewdeleterecords.indexOf(item1);
      this.viewdeleterecords.splice(index1, 1);
      this.activeeditlist.splice(index1, 1);
      console.log('delete', this.viewdeleterecords);
    }

    console.log(this.checkedlist.length);
    if (this.checkedlist.length == this.holidays.length) {
      this.holidays.forEach((val: any) => {
        if (val.checked == true) {
          this.selectall();
          this.isunselectall = false;
    ...
    console.log(this.activeeditlist);
  }
  ...
  selectall() {
    ...
    if (this.isselectall) {
      this.holidays.forEach((val: any) => {
        val.checked = true;
        this.checkedlist.push(val.holidayId);
      });
    }
    this.holidays.forEach((val: any) => {
      this.activeeditlist.push(val);
  ...
  editbuttinactive() {
    if (this.activedelete == true) {
      console.log('entered', this.activeeditlist)
      this.activededit = true;

      this.holidays.forEach((val: any) => {
        this.activeditrow(val.holidayId);
        if (val.sequence == 1) {

        }

      });
      this.activeeditlist.forEach((val1: any) => {

        document.getElementById('doubletabrow' + val1.holidayId)?.classList.remove('opacitytr');
        document.getElementById('editrow1holiday' + val1.holidayId)?.classList.remove('hide');
        document.getElementById('editrow2holiday' + val1.holidayId)?.classList.add('hide');
        document.getElementById('editrow4holiday' + val1.holidayId)?.classList.remove('hide');
        document.getElementById('editrow5holiday' + val1.holidayId)?.classList.add('hide');
        if (val1.observeAsWorkDay == false) {
          document.getElementById('editrow6holiday' + val1.holidayId)?.classList.add('hide');
          document.getElementById('editrow7holiday' + val1.holidayId)?.classList.remove('hide');
        } else {
          document.getElementById('editrow6holiday' + val1.holidayId)?.classList.remove('hide');
          document.getElementById('editrow7holiday' + val1.holidayId)?.classList.add('hide');
        }
        document.getElementById('editrow8holiday' + val1.holidayId)?.classList.remove('hide');
        document.getElementById('editrow9holiday' + val1.holidayId)?.classList.add('hide');
        document.getElementById('holidayedittext' + val1.holidayId)?.focus();
      });

      this.holidays.forEach((valchecked: any) => {
        if (valchecked.checked == false) {
          document.getElementById('doubletabrow' + valchecked.holidayId)?.classList.remove('opacitytr');
          document.getElementById('editrow2holiday' + valchecked.holidayId)?.classList.add('hide');
          document.getElementById('editrow10holiday' + valchecked.holidayId)?.classList.remove('hide');
          document.getElementById('editrow4holiday' + valchecked.holidayId)?.classList.add('hide');
          document.getElementById('editrow5holiday' + valchecked.holidayId)?.classList.remove('hide');
          document.getElementById('editrow6holiday' + valchecked.holidayId)?.classList.add('hide');
          document.getElementById('editrow7holiday' + valchecked.holidayId)?.classList.remove('hide');
          document.getElementById('editrow8holiday' + valchecked.holidayId)?.classList.add('hide');
          document.getElementById('editrow9holiday' + valchecked.holidayId)?.classList.remove('hide');
        } else {
        }
      });
  ...
  activeditrow(id: any) {
    ...
    this.holidays.forEach((val: any) => {
      if (val.holidayId != id) {
        document.getElementById('checkboxrow' + val.holidayId)?.classList.add('hide');
        document.getElementById('checkboxrows' + val.holidayId)?.classList.remove('hide');
      }
    });
  }
  inactiveditrow(id: any) {
    ...
    if (this.activeeditlist.length == 0) {
      ...
      this.holidays.forEach((val1: any) => {
        document.getElementById('checkboxrow' + val1.holidayId)?.classList.remove('hide');
        document.getElementById('checkboxrows' + val1.holidayId)?.classList.add('hide');
      });
    }
  ...
  editsinglerow(id: any) {
    this.holidays.forEach((val: any) => {
      if (val.holidayId == id) {
        val.checked = true;
        this.activeeditlist.push(val);
        document.getElementById('editrow1holiday' + val.holidayId)?.classList.remove('hide');
        document.getElementById('editrow10holiday' + val.holidayId)?.classList.add('hide');
        document.getElementById('editrow4holiday' + val.holidayId)?.classList.remove('hide');
        document.getElementById('editrow5holiday' + val.holidayId)?.classList.add('hide');
        if (val.observeAsWorkDay == false) {
          document.getElementById('editrow6holiday' + val.holidayId)?.classList.add('hide');
          document.getElementById('editrow7holiday' + val.holidayId)?.classList.remove('hide');
          document.getElementById('editrow9holiday' + val.holidayId)?.classList.remove('hide');
          document.getElementById('editrow8holiday' + val.holidayId)?.classList.add('hide');
        } else {
          document.getElementById('editrow6holiday' + val.holidayId)?.classList.remove('hide');
          document.getElementById('editrow7holiday' + val.holidayId)?.classList.add('hide');
          document.getElementById('editrow8holiday' + val.holidayId)?.classList.remove('hide');
          document.getElementById('editrow9holiday' + val.holidayId)?.classList.add('hide');
        }
  ...
  editallbuttonactive() {
    this.holidays.forEach((val: any) => {
      ...
      this.activeditrow(val.holidayId);
      if (val.sequence == 1) {
        document.getElementById('holidayedittext' + val.holidayId)?.focus();
      }

    });
    this.activeeditlist = [];
    this.holidays.forEach((valchecked: any) => {
      this.activeeditlist.push(valchecked);
      document.getElementById('editrow1holiday' + valchecked.holidayId)?.classList.remove('hide');
      document.getElementById('editrow10holiday' + valchecked.holidayId)?.classList.add('hide');
      document.getElementById('editrow4holiday' + valchecked.holidayId)?.classList.remove('hide');
      document.getElementById('editrow5holiday' + valchecked.holidayId)?.classList.add('hide');
      if (valchecked.observation == false) {
        document.getElementById('editrow6holiday' + valchecked.holidayId)?.classList.add('hide');
        document.getElementById('editrow7holiday' + valchecked.holidayId)?.classList.remove('hide');
        document.getElementById('editrow9holiday' + valchecked.holidayId)?.classList.remove('hide');
        document.getElementById('editrow8holiday' + valchecked.holidayId)?.classList.add('hide');
      } else {
        document.getElementById('editrow6holiday' + valchecked.holidayId)?.classList.remove('hide');
        document.getElementById('editrow7holiday' + valchecked.holidayId)?.classList.add('hide');
        document.getElementById('editrow8holiday' + valchecked.holidayId)?.classList.remove('hide');
        document.getElementById('editrow9holiday' + valchecked.holidayId)?.classList.add('hide');
      }
  ...
  inactivedoneall() {
    ...
    this.holidays.forEach((val: any) => {
      ...
      document.getElementById('eheader2')?.classList.add('hide');
      document.getElementById('editrow10holiday' + val.holidayId)?.classList.add('hide');
      document.getElementById('editrow1holiday' + val.holidayId)?.classList.add('hide');
      document.getElementById('editrow2holiday' + val.holidayId)?.classList.remove('hide');
      document.getElementById('editrow4holiday' + val.holidayId)?.classList.add('hide');
      document.getElementById('editrow5holiday' + val.holidayId)?.classList.remove('hide');
      document.getElementById('editrow6holiday' + val.holidayId)?.classList.add('hide');
      document.getElementById('editrow7holiday' + val.holidayId)?.classList.remove('hide');
      document.getElementById('editrow8holiday' + val.holidayId)?.classList.add('hide');
      document.getElementById('editrow9holiday' + val.holidayId)?.classList.remove('hide');
  ...
  savesinglerow(id: any) {
    ...
    let item = this.activeeditlist.filter(function (item: any) {
      return item.id === id;
    })[0];
    let index = this.activeeditlist.indexOf(item);
    this.activeeditlist.splice(index, 1);
    document.getElementById('editrow10holiday' + id)?.classList.remove('hide');
    document.getElementById('editrow1holiday' + id)?.classList.add('hide');
    document.getElementById('editrow4holiday' + id)?.classList.add('hide');
    document.getElementById('editrow5holiday' + id)?.classList.remove('hide');
    document.getElementById('editrow6holiday' + id)?.classList.add('hide');
    document.getElementById('editrow7holiday' + id)?.classList.remove('hide');
    document.getElementById('editrow8holiday' + id)?.classList.add('hide');
    document.getElementById('editrow9holiday' + id)?.classList.remove('hide');
  ...
  //view popup extra functions
  holidayedit2popup(id: any) {
    this.singleholiday = [];
    this.holidays.forEach((val: any) => {
      if (val.holidayId == id) {
        this.singleholiday.push(val);
  ...
  deletebtn() {
    ...
    this.deletetext = 'Holiday';
    this.deletetext2 = 'this Holiday';
    this.singleholiday.forEach((val: any) => {
      this.deleterecords.push(val);
      this.sequencedelete();
    });
  ...
  deletenumber() {
    if (this.activedelete == true) {
      ...
      if (this.deleterecords.length == 1) {
        ...
        this.deletetext = 'Holiday';
        this.deletetext2 = 'these Holidays';
      }
    } else {
  ...
  deletepopupwidth() {
    ...
    this.deleterecords.forEach((val: any) => {
      let a = val.holidayName;
      this.deletearray.push(a.length);

    });
    var maxcha = this.deletearray.reduce((a: number, b: number) => Math.max(a, b));
    if (maxcha <= 16) {
    ...
    this.delete2array = [];
    this.deleterecords.forEach((val: any) => {
      let b = val.observationDayMethod.split(' ').length;
      this.delete2array.push(b);
    });
    var max = this.delete2array.reduce((a: number, b: number) => Math.max(a, b));
    if (max == 4) {
      document.documentElement.style.setProperty('--x', '45px');
    } else if (max == 5) {
      document.documentElement.style.setProperty('--x', '105px');
    }
  }
  closedeletewidth() {
    document.documentElement.style.setProperty('--y', '0px');
  ...
  deletecomfirm() {
    if (this.activededit == true) {
      ...
      console.log('Updated list', this.holidays)
    } else {
      this.add = 0;
      this.deleterecords.forEach((val: any) => {
        this.add++;
