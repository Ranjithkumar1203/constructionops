...
namespace Login.Infrastructure.Dapper
{
    public class Dapperr : IDapper
    {
        ...
        private string Connectionstring = "LoginConnectionString";
        ...
        public object ExecuteScalar(string sp, DynamicParameters parms, CommandType commandType = CommandType.Text)
        {
